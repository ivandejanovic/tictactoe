(function() {
    ...
    gameObj.checkWin = function(char) {
        ...
        for (i = 0; i < 3; ++i) {
            if (this.gameState[i][0] === char && this.gameState[i][1] === char
        ...
        for (i = 0; i < 3; ++i) {
            if (this.gameState[0][i] === char && this.gameState[1][i] === char
        ...
        if (this.gameState[0][0] === char && this.gameState[1][1] === char
                && this.gameState[2][2] === char) {
            return true;
        }
        if (this.gameState[2][0] === char && this.gameState[1][1] === char
    ...
    gameObj.drawO = function(x, y) {
        ...
        this.context.arc(c.beginX + ((c.endX - c.beginX) / 2), c.beginY
                + ((c.endY - c.beginY) / 2), (c.endX - c.beginX) / 2, 0,
                Math.PI * 2, true);
    ...
    // method that handles computers move and returns true if computer won and
    // false otherwise
