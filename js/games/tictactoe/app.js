(function($) {
    ...
    app.OptionsView = app.BasicView.extend({
    	...
    	handleFirstClick: function(evt) {
    		this.turnModel.set({first: true});
    	},
    	handleSecondClick: function(evt) {
    		this.turnModel.set({first: false});
    	}
    ...
    var Router = Backbone.Router.extend({
        ...
        initialize: function(options) {
            ...
            this.play = new app.PlayView({turnModel: turnModel});
            this.options = new app.OptionsView({turnModel: turnModel});
